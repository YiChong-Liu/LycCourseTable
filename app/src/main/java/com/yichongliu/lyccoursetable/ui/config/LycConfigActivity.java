 ...
 * Author: Yichong·Liu
 * Date:2020.5.25 */
public class LycConfigActivity extends AppCompatActivity{
    ...
    private float mAlpha = LycConfig.getCardViewAlpha();
    private int mBgId = LycConfig.getBgId();


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lyc_config);
        ...
        int value = (int) (LycConfig.getCardViewAlpha() * 100);
        String s = value + "%";
        ...
        cleanBtn.setOnClickListener(view -> {
            LycCalendarReminderUtils.deleteCalendarEvent(LycConfigActivity.this
    ...
    private void initGridView()
    {
        ...
        final LycBgBtnAdapter bgBtnAdapter=new LycBgBtnAdapter(this);
    ...
    private void setCardViewAlpha() {
        float alpha = LycConfig.getCardViewAlpha();
    ...
    private boolean isConfigChange() {
        return (mBgId != LycConfig.getBgId() || mAlpha != LycConfig.getCardViewAlpha());
    }
    ...
    private void saveConfig() {
        LycConfig.setCardViewAlpha(mAlpha);
        LycConfig.setBgId(mBgId);
        LycConfig.saveSharedPreferences(this);
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_CODE_SYSTEM_PIC) {
                if (data != null) {
                    ...
                    String path = LycFileUtils.getPath(this, imgUri);
                    ...
                    if(height>dm.heightPixels||width>dm.widthPixels)
                    {
                        ...
                        LycFileUtils.fileCopy(path, sPath + File.separator + BG_NAME);
                        showUserSelectBg(0);
                    } else {
    ...
    public void showUserSelectBg(int id)
    {
        ...
        LycUtils.refreshBg(this,id);
        LycUtils.setBackGround(this,mBgImageView, mBgId);
        if(id==0)
            setUpdateResult();
    }
