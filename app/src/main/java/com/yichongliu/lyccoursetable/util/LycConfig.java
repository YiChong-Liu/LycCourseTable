...
public class LycConfig {
    ...
    public static void setCardViewAlpha(float cardViewAlpha) {
        if (cardViewAlpha > 1.0f)
            ...
            cardViewAlpha = 0.1f;
        LycConfig.cardViewAlpha = cardViewAlpha;
    }
    ...
    public static void setCurrentWeek(int currentWeek) {
        LycConfig.currentWeek = currentWeek;
    }
    ...
    public static void setFlagCurrentWeek(boolean flagCurrentWeek) {
        LycConfig.flagCurrentWeek = flagCurrentWeek;
    }
    ...
    public static void setCollegeName(String collegeName) {
        LycConfig.collegeName = collegeName;
    }
    ...
    public static void saveCurrentWeek(final Context context) {
        SharedPreferences sharedPreferences =
                context.getSharedPreferences("data", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        Log.d("weeknum", "save=" + (LycUtils.getWeekNum() - currentWeek));
        editor.putLong(KEY_WEEK_OF_TERM, LycUtils.getWeekNum() - currentWeek);
        editor.apply();
    }
    ...
    public static void readFormSharedPreferences(Context context) {
        ...
        long weekNum = LycUtils.getWeekNum();
